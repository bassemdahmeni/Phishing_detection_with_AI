...
def main_test(test_base_path, model_path, vectorizer_path):
    test_model(test_base_path, model_path, vectorizer_path)
...
main_test(r"C:\Users\user\OneDrive\Bureau\Academics\pcd\extract\test_links", 'phishing_model.pkl', 'vectorizer.pkl')
