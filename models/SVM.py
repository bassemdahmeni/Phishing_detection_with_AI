...
def main():
    ...
    df = pd.read_csv("csv_files/final1.0.csv")
    ...
    pipeline = Pipeline([
        ...
        ('rf', SVC(kernel='linear', max_iter=10000, verbose=False))
    ])
    
    
    print("\n🧠 Starting training of SVM avec pipeline...")
    ...
    joblib.dump(pipeline, "models/SVM_pipeline2.pkl")
